            ...
            <div class="col-12 col-lg-4 d-none d-lg-block">
                <div class="card card-slick-custom static-sticky-class">
                    <div class="block-over-img">
                        <img class="card-img-top w-100" src="<?php echo $courses['image']['original'] ?>" alt="<?php echo $courses['title'] ?>" height="200">
                    </div>
...
<nav class="d-block d-lg-none bottom-stiky-class fixed-bottom">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex flex-wrap align-items-center">
                <div class="mr-4"><img class="img-module-bottom img-fluid" src="<?php echo $courses['image']['original'] ?>" alt="<?php echo $courses['title'] ?>"></div>
                <div>
