    ...
    <div class="c-card u-mb-xsmall card-uxorbit">
        ...
        <form class="c-card__body using-captcha user card-padding-top" action="<?php echo base_url('auth/register') ?>" method="POST">
            ...
            <div class="form-group">
                <label for="exampleFormControlInput1"><?php echo $this->lang->line('full_name') ?></label>
                <input required='' id="exampleFormControlInput1" value="<?php echo set_value('full_name'); ?>" autofocus="" name='full_name' class="c-input form-control form-size" type="text" placeholder="<?php echo $this->lang->line('full_name') ?>">
            ...
            <div class="form-group">
                <label for="exampleFormControlInput3"><?php echo $this->lang->line('no_handphone') ?></label>
                <input required='' id="exampleFormControlInput3" value="<?php echo set_value('no_handphone'); ?>" name='no_handphone' class="c-input form-control form-size" type="number" placeholder="<?php echo $this->lang->line('no_handphone') ?>">
