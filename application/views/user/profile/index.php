					...
					<div class="c-stage u-mb-zero">
						...
						<div class="c-stage__panel u-ph-medium u-pv-small">
								...
								<div class="col-sm-9">
									<select name="jenis_kelamin" id="jenis_kelamin" class="form-control">
										<?php foreach ($data as $jk) : ?>
											<?php if ($jk == $profile['jenis_kelamin']) : ?>
							...
							<div class="row u-mb-medium">
								...
								<div class="col-sm-9">
									<select name="occupation" id="occupation" class="form-control">
										<?php foreach ($occupation as $oku) : ?>
											<?php if ($oku == $profile['occupation']) : ?>
												<option value="<?= $oku; ?>" selected><?= $oku; ?></option>
											<?php else : ?>
							...
							<div class="row u-mb-medium">
								...
								<div class="col-sm-9">
									<input type="text" name="nama_institusi" class="c-input" value="<?php echo (!empty($profile['nama_institusi'])) ? (!empty(set_value('nama_institusi')) ? set_value('nama_institusi') : $profile['nama_institusi']) : set_value('nama_institusi') ?>" />
									<?php echo form_error('nama_institusi', '<small class="c-field__message u-color-danger"><i class="fa fa-times-circle"></i>', '</small>'); ?>
								</div>
							</div>
							...
							<div class="row u-mb-medium">
								...
								<div class="col-sm-9">
									<input type="text" name="link_portfolio" class="c-input" value="<?php echo (!empty($profile['link_portfolio'])) ? (!empty(set_value('link_portfolio')) ? set_value('link_portfolio') : $profile['link_portfolio']) : set_value('link_portfolio') ?>" />
									<?php echo form_error('link_portfolio', '<small class="c-field__message u-color-danger"><i class="fa fa-times-circle"></i>', '</small>'); ?>
								</div>
							</div>
